@extends('member.layout.template')
@push('css')
...
@include('member.modal_tambah')
@include('member.modal_edit')
@endsection
    ...
    function editCategori(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.action').attr('action', '{{url("member/wisata")}}' + '/' + data.id);
